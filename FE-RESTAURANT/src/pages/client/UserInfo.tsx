...
const UserInfo: React.FC = () => {
    ...
    (async () => {
      try {
        ...
        if (avatarUrl) {
          ...
          console.log('UserInfo: Avatar loaded from storage:', avatarUrl);
        } else if (res.avatarUrl) {
          console.log('UserInfo: Using avatar from API:', res.avatarUrl);
        }
  ...
  const handleAvatarChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      try {
        console.log('=== USERINFO AVATAR UPLOAD DEBUG ===');
        ...
        console.log('=== END USERINFO AVATAR UPLOAD DEBUG ===');
      } catch (error: any) {
